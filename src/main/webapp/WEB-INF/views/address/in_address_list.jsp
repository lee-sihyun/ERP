...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">내부 주소록</h1>
			<!-- end page-header -->
	...
	<table id="data-table" class="table table-striped table-bordered">
		...
		<tbody>
			{{#each .}}
			<tr class="odd gradeX">
				<td align="center"><a href="${pageContext.servletContext.contextPath }/address/inaddressView?empNo={{empNo}}">{{empName}}</a></td>
				<td align="center"><a href="${pageContext.servletContext.contextPath }/address/inaddressView?empNo={{empNo}}">{{deptName}}</a></td>
				<td align="center"><a href="${pageContext.servletContext.contextPath }/address/inaddressView?empNo={{empNo}}">{{empPosition}}</a></td>
				<a href="${pageContext.servletContext.contextPath }/address/inaddressView?empNo={{empNo}}"><td align="center">{{empEmail}}</td></a>
				<a href="${pageContext.servletContext.contextPath }/address/inaddressView?empNo={{empNo}}"><td align="center">{{extension}}</td></a>
				<a href="${pageContext.servletContext.contextPath }/address/inaddressView?empNo={{empNo}}"><td align="center">{{empState}}</td></a>
			</tr>
			{{/each}}
 		</tbody>
 	</table>
	...
	function addressDisplay(pageNum){
		...
		$.ajax({
			type: "POST",
			url: "${pageContext.servletContext.contextPath }/address/inaddressList",
			data: {"pageNum":pageNum, "search":search, "keyword":keyword},
			dataType: "json",
			success: function(json){
				if(json.inAddressList.length==0) {
				...
				$("#panel-body").html(template(json.inAddressList));
