                    ...
                    <div class="wrapper">
                       ...
                       <!-- 받는사람과 보내는 사람 = 시작 -->
                        <ul class="media-list underline m-b-20 p-b-15">
                            <li class="media media-sm clearfix">
                                ...
                                <div class="media-body">
                                    <span class="email-to">
                                    <h3 class="m-b-15 m-t-0 p-b-10 underline">${sendmessageView.title}</h3>
                                    </span>
                                    
                                    <span class="email-from text-inverse f-w-600">
                                      
                                   	받은 사람 : ${sendmessageView.recvEmpName}
                                    
                                    </span>
                                    
                                    <span class="text-muted m-l-5"><i class="fa fa-clock-o fa-fw"></i>${sendmessageView.sendDate}</span><br />
                        ...
                        <p class="f-s-12 text-inverse"> 
                         ${sendmessageView.content}
                        </p>
                        <br />
                        <br />
                        <p class="f-s-12 text-inverse">
                            ${sendmessageView.recvDeptName}팀<br />
                            ${sendmessageView.recvEmpName}&nbsp;${sendmessageView.recvEmpPosition} 받음
