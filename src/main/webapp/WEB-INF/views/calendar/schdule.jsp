...
<script type="text/javascript" src="${pageContext.servletContext.contextPath }/calendar/js/stringBuffer.js"></script>
<script type="text/javascript" src="${pageContext.servletContext.contextPath }/calendar/js/calendar.js"></script>
<script type="text/javascript" src="${pageContext.servletContext.contextPath }/calendar/js/calendarSchdule.js?var=1"></script>
		...
		<thead id='thead'>
			<tr>
				<td colspan="7">
					...
					<button type='button' class='btn btn-sm btn-warning' id='movePre' onclick="moveMonthPre()">&lsaquo;</button> &nbsp;&nbsp; <span id='yearMonth'></span> &nbsp;&nbsp;
					...
					<div style="text-align: right;">
						<span>${title}</span> <input class='btn btn-sm btn-info' type="button" value="주" onclick='tabWeek()' /> <input class='btn btn-sm btn-info' type="button" value="월" onclick='tabMonth()' />
					</div>
				</td>
			</tr>
			<tr>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" id="calendarId" name="calendarId" value="jisuneom12@gmail.com">
