   ...
   <div class="panel-heading p-0">
                            ...
                            <div class="tab-overflow">
                                <ul class="nav nav-tabs nav-tabs-inverse" style="text-align: center;">
                                    ...
                                    <li class="active"><a href="${pageContext.servletContext.contextPath}/draft/display" style="width: 150px;" >기안서</a></li>
								...
								<c:forEach var="draft" items="${draftList }">
									...
									<tr>
										<td style="text-align: center;">
											...
											<a href="${pageContext.request.contextPath }/draft/view?draftNo=${draft.draftNo}" class="draft"> ${draft.draftNo } </a>
										</td>




										<td style="text-align: center;">${draft.writer }</td>

										<td style="text-align: center;">${draft.draftTitle }</td>

										<td style="text-align: center;"> ${draft.writeDate}</td>
										...
										<td style="text-align: center;">
											 ...
											 <c:if 	test="${draft.approve==1}">미확인</c:if>
											 <c:if 	test="${draft.approve==2}">결재중</c:if>
											 <c:if 	test="${draft.approve==3}">결재중</c:if>
											 <c:if 	test="${draft.approve==4}">결재완료</c:if>
											 <c:if 	test="${draft.approve==0}">반려</c:if>
