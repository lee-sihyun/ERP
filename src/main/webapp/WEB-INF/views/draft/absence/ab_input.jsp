					...
					<!-- 시작 -->
                            ...
                            <div class="tab-overflow">
                                <ul class="nav nav-tabs nav-tabs-inverse" style="text-align: center;">
                                    ...
                                    <li class="active"><a href="${pageContext.servletContext.contextPath}/draft/absence"  style="width: 150px;" >휴직</a></li>
...
<table style="border: 0px solid rgb(0, 0, 0); border-image: none; width: 800px; font-family: malgun gothic,dotum,arial,tahoma; margin-top: 10px; border-collapse: collapse;"><!-- Data1 --> 
 ...
 휴직기간 
			...
			<td style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; border-image: none; text-align: left; color: rgb(0, 0, 0); font-size: 14px; font-weight: normal; vertical-align: middle;" colspan="4">
				...
				<input class="ipt_editor ipt_editor_date" type="text" id="absenceStartDate"> ~ 
				
				
				
				<input class="ipt_editor ipt_editor_date" type="text" id="absenceEndDate">
 ...
 휴직사유 
			...
			<td style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; border-image: none; text-align: left; color: rgb(0, 0, 0); font-size: 14px; font-weight: normal; vertical-align: top;" colspan="4">
				...
				<textarea class="txta_editor" id="absenceReason" cols="100" rows="10"></textarea>
...
&nbsp;기타사항 
 ...
 <br><span style="font-family: &quot;malgun gothic&quot;; font-size: 10pt; line-height: normal; margin-top: 0px; margin-bottom: 0px;">※ 휴직 신청 및 확인시 첨부서류 : 진단서 1부</span> <br> </span>
<p style="font-family: &quot;맑은 고딕&quot;; font-size: 10pt; line-height: 20px; margin-top: 0px; margin-bottom: 0px;"><br></p>


<button type="button"  style="margin-left: 320px;"class="btn btn-primary p-l-40 p-r-40" id="submit" >결재제출</button>
	...
	<script>
		...
		$("#submit").click(function(){
			...
			var absenceStartDate=$("#absenceStartDate").val();
			var absenceEndDate=$("#absenceEndDate").val(); 
			...
			$.ajax({
				...
				"writer":writer,"absenceStartDate":absenceStartDate, "absenceEndDate":absenceEndDate,"absenceReason":absenceReason,
