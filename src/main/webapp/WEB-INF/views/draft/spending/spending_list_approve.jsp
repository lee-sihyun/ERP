					...
					<div class="col-md-2">
						...
						<div class="hidden-sm hidden-xs">
							...
							<ul class="nav nav-pills nav-stacked nav-inbox">
								<li class=""><a href="${pageContext.request.contextPath }/draft/display"> 
   ...
   <div class="panel-heading p-0">
                            ...
                            <div class="tab-overflow">
                                <ul class="nav nav-tabs nav-tabs-inverse" style="text-align: center;">
                                    ...
                                    <li class="active"><a href="${pageContext.servletContext.contextPath}/draft/spendingapprove"  style="width: 150px;" >지출결의서</a></li>
								...
								<c:forEach var="spending" items="${spendingList1}">
									...
									<tr style="text-align: center;">
										<td style="text-align: center;">
											...
											<a href="${pageContext.request.contextPath }/draft/approve1sp?draftNo=${spending.draftNo}" class="spending"> ${spending.draftNo } </a>
										</td>
