					...
					<div class="col-md-2">
						...
						<div class="hidden-sm hidden-xs">
							...
							<ul class="nav nav-pills nav-stacked nav-inbox">
								...
								<li><a href="#"><i class="fa fa-folder fa-fw m-r-5"></i> Downloaded</a></li> </ul>-->
</div>
				</div>
					<!-- end col-2 -->
					<!-- begin col-10 -->
   ...
   <div class="panel-heading p-0">
                            ...
                            <div class="tab-overflow">
                                <ul class="nav nav-tabs nav-tabs-inverse" style="text-align: center;">
                                    ...
                                    <li class="active"><a href="${pageContext.servletContext.contextPath}/draft/productapprove"style="width: 150px;" >비품구입</a></li>
								...
								<c:forEach var="product" items="${productList1}">
									...
									<tr style="text-align: center;">
										<td style="text-align: center;">
											...
											<a href="${pageContext.request.contextPath }/draft/approve1pd?draftNo=${product.draftNo}" class="product"> ${product.draftNo } </a>
										</td>
