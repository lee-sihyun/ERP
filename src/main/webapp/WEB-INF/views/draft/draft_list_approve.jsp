   ...
   <div class="panel-heading p-0">
                            ...
                            <div class="tab-overflow">
                                <ul class="nav nav-tabs nav-tabs-inverse" style="text-align: center;">
                                    ...
                                    <li class="active"><a href="${pageContext.servletContext.contextPath}/draft/draftapprove" style="width: 150px;" >기안서</a></li>
								...
								<c:forEach var="draft" items="${draftList1 }">
									...
									<tr style="text-align: center;">
										<td style="text-align: center;">
											...
											<a href="${pageContext.request.contextPath }/draft/approve1?draftNo=${draft.draftNo}" class="draft"> ${draft.draftNo } </a>
										</td>
