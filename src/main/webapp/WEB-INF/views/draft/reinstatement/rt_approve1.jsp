...
<td style="
    border: 1px solid;
">${reinstatement.signerOne }</td>
<td style="
    border: 1px solid;
">${reinstatement.signerTwo }</td>
<td style="
    border: 1px solid;
">${reinstatement.signerThree}</td>
...
">
 ...
 <c:if 	test="${reinstatement.approve==4}">결재승인</c:if>
...
<c:if 	test="${reinstatement.approve==4}">결재승인</c:if>
<c:if 	test="${reinstatement.approve==3}">결재승인</c:if>
...
<c:if 	test="${reinstatement.approve==4}">결재승인</c:if>
 <c:if 	test="${reinstatement.approve==3}">결재승인</c:if>
 <c:if 	test="${reinstatement.approve==2}">결재승인</c:if>
<c:if 	test="${reinstatement.approve==0}">반려</c:if>
...
휴직일
			...
			<td style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; border-image: none; text-align: left; color: rgb(0, 0, 0); font-size: 14px; font-weight: normal; vertical-align: middle;" colspan="4">
				...
				${reinstatement.reinStart}
				
				${reinstatement.reinEnd}
...
&nbsp;기타사항 
			...
			<td style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; border-image: none; text-align: left; color: rgb(0, 0, 0); font-size: 14px; font-weight: normal; vertical-align: middle;" colspan="4">
				<span style="font-family: &quot;malgun gothic&quot;; font-size: 10pt; line-height: normal; margin-top: 0px; margin-bottom: 0px;">-해당 부서장과 면담 후 복직처리가 완료됨을 알려드립니다.</span><br>  
			</td>
		</tr>
...
<p style="font-family: &quot;맑은 고딕&quot;; font-size: 10pt; line-height: 20px; margin-top: 0px; margin-bottom: 0px;"><br></p>
	...
	<script>
		...
		function submitDraft() {
			 var draftNo="${reinstatement.draftNo}";
		...
		function rejectDraft() {
			 var draftNo="${reinstatement.draftNo}";
			 var signerOneApprove="${resignation.signerOneApprove}";
