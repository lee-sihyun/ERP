					...
					<div class="col-md-2">
						...
						<div class="hidden-sm hidden-xs">
							...
							<ul class="nav nav-pills nav-stacked nav-inbox">
								<li ><a href="${pageContext.request.contextPath }/draft/display"> <i class="fa fa-inbox fa-fw m-r-5"></i> 결재함
								</a></li>
								...
								<li class="active"><a href="${pageContext.request.contextPath }/draft/draftreject"><i class="fa fa-trash-o fa-fw m-r-5"></i> 반려</a></li>
   ...
   <div class="panel-heading p-0">
                            ...
                            <div class="tab-overflow">
                                <ul class="nav nav-tabs nav-tabs-inverse" style="text-align: center;">
                                    ...
                                    <li class=""><a href="${pageContext.servletContext.contextPath}/draft/draftreject" style="width: 150px;" >기안서</a></li>
                                    <li class=""><a href="${pageContext.servletContext.contextPath}/draft/spendingreject"  style="width: 150px;" >지출결의서</a></li>
                                    <li class=""><a href="${pageContext.servletContext.contextPath}/draft/productreject"style="width: 150px;" >비품구입</a></li>
                                    <li class=""><a href="${pageContext.servletContext.contextPath}/draft/purchasereject"  style="width: 150px;" >구매품의서</a></li>
                                    <li class=""><a href="${pageContext.servletContext.contextPath}/draft/confreject"  style="width: 150px;" >회의록</a></li>
                                    <li class=""><a href="${pageContext.servletContext.contextPath}/draft/abreject"  style="width: 150px;" >휴직</a></li>
                                    <li class=""><a href="${pageContext.servletContext.contextPath}/draft/resreject"  style="width: 150px;" >퇴직</a></li>
                                    <li class="active"><a href="${pageContext.servletContext.contextPath}/draft/rtreject"  style="width: 100px;" >복직</a></li>
	...
	<table class="table table-striped">
								...
								<c:forEach var="reinstatement" items="${rtRejctList }">
									...
									<tr style="text-align: center;">
										<td style="text-align: center;">
											...
											<a href="${pageContext.request.contextPath }/draft/rtview?draftNo=${reinstatement.draftNo}" class="reinstatement"> ${reinstatement.draftNo } </a>
										</td>




										<td style="text-align: center;">${reinstatement.writer }</td>


										<td style="text-align: center;">${reinstatement.writeDate}</td>


										<td style="text-align: center;">복직원</td>

										
										
										<td style="text-align: center;">
										
											 <c:if 	test="${reinstatement.approve==1}">미확인</c:if>
											 <c:if 	test="${reinstatement.approve==2}">결재중</c:if>
											 <c:if 	test="${reinstatement.approve==3}">결재중</c:if>
											 <c:if 	test="${reinstatement.approve==4}">결재완료</c:if>
											 <c:if 	test="${reinstatement.approve==0}">반려</c:if>
