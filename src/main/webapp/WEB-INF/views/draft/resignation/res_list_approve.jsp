   ...
   <div class="panel-heading p-0">
                            ...
                            <div class="tab-overflow">
                                <ul class="nav nav-tabs nav-tabs-inverse" style="text-align: center;">
                                    ...
                                    <li class="active"><a href="${pageContext.servletContext.contextPath}/draft/resapprove"  style="width: 150px;" >퇴직</a></li>
...
<table class="table table-striped">
								...
								<c:forEach var="resignation" items="${resList1 }">
									...
									<tr style="text-align: center;">
										<td style="text-align: center;">
											...
											<a href="${pageContext.request.contextPath }/draft/approve1res?draftNo=${resignation.draftNo}" class="resignation"> ${resignation.draftNo } </a>
										</td>
