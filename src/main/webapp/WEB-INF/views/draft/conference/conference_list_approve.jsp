   ...
   <div class="panel-heading p-0">
                            ...
                            <div class="tab-overflow">
                                <ul class="nav nav-tabs nav-tabs-inverse" style="text-align: center;">
                                    ...
                                    <li class="active"><a href="${pageContext.servletContext.contextPath}/draft/confapprove"  style="width: 150px;" >회의록</a></li>
...
<table class="table table-striped">
								...
								<c:forEach var="conference" items="${confList1 }">
									...
									<tr style="text-align: center;">
										<td style="text-align: center;">
											...
											<a href="${pageContext.request.contextPath }/draft/approve1co?draftNo=${conference.draftNo}" class="conference"> ${conference.draftNo } </a>
										</td>
