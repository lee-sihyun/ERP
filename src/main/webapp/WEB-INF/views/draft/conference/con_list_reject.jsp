   ...
   <div class="panel-heading p-0">
                            ...
                            <div class="tab-overflow">
                                <ul class="nav nav-tabs nav-tabs-inverse" style="text-align: center;">
                                    ...
                                    <li class="active"><a href="${pageContext.servletContext.contextPath}/draft/confreject"  style="width: 150px;" >회의록</a></li>
                                    ...
                                    <li class=""><a href="${pageContext.servletContext.contextPath}/draft/rtreject"  style="width: 100px;" >복직</a></li>
	...
	<table class="table table-striped">
								...
								<c:forEach var="conference" items="${confRejctList }">
									...
									<tr style="text-align: center;"> 
										<td style="text-align: center;">
											...
											<a href="${pageContext.request.contextPath }/draft/coview?draftNo=${conference.draftNo}" class="conference"> ${conference.draftNo } </a>
										</td>




										<td style="text-align: center;">${conference.writer }</td>




										<td style="text-align: center;">${conference.confTitle}</td>

										<td style="text-align: center;">${conference.writeDate}</td>
										
										
										<td style="text-align: center;">
										
											 <c:if 	test="${conference.approve==1}">미확인</c:if>
											 <c:if 	test="${conference.approve==2}">결재중</c:if>
											 <c:if 	test="${conference.approve==3}">결재중</c:if>
											 <c:if 	test="${conference.approve==4}">결재완료</c:if>
