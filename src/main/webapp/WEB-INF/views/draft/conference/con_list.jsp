   ...
   <div class="panel-heading p-0">
                            ...
                            <div class="tab-overflow">
                                <ul class="nav nav-tabs nav-tabs-inverse" style="text-align: center;">
                                    ...
                                    <li class="active"><a href="${pageContext.servletContext.contextPath}/draft/codisplay"  style="width: 150px;" >회의록</a></li>
                                    ...
                                    <li class=""><a href="${pageContext.servletContext.contextPath}/draft/rtdisplay"  style="width: 150px;" >복직</a></li>
                        ...
                        <!-- 탭끝 -->
							...
							<table class="table table-striped">
								...
								<c:forEach var="conference" items="${conList }">
