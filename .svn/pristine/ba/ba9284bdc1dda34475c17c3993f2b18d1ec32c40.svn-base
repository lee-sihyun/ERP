   ...
   <div class="panel-heading p-0">
                            ...
                            <div class="tab-overflow">
                                <ul class="nav nav-tabs nav-tabs-inverse" style="text-align: center;">
                                    ...
                                    <li class="active"><a href="${pageContext.servletContext.contextPath}/draft/abreject"  style="width: 150px;" >휴직</a></li>
	...
	<table class="table table-striped">
								...
								<c:forEach var="absence" items="${abRejctList }">
									...
									<tr style="text-align: center;">
										<td style="text-align: center;">
											...
											<a href="${pageContext.request.contextPath }/draft/abview?draftNo=${absence.draftNo}" class="absence"> ${absence.draftNo } </a>
										</td>




										<td style="text-align: center;">${absence.writer }</td>

										<td style="text-align: center;">휴직원</td>

										<td style="text-align: center;">${absence.writeDate}</td>
										...
										<td>
											 ...
											 <c:if 	test="${absence.approve==1}">미확인</c:if>
											 <c:if 	test="${absence.approve==2}">결재중</c:if>
											 <c:if 	test="${absence.approve==3}">결재중</c:if>
											 <c:if 	test="${absence.approve==4}">결재완료</c:if>
