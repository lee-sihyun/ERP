   ...
   <div class="panel-heading p-0">
                            ...
                            <div class="tab-overflow">
                                <ul class="nav nav-tabs nav-tabs-inverse" style="text-align: center;">
                                    ...
                                    <li class=""><a href="${pageContext.servletContext.contextPath}/draft/purchaseapprove"  style="width: 150px;" >구매품의서</a></li>
                                    ...
                                    <li class="active"><a href="${pageContext.servletContext.contextPath}/draft/rtapprove"  style="width: 100px;" >복직</a></li>
...
<table class="table table-striped">
								...
								<c:forEach var="reinstatement" items="${rtList1 }">
									...
									<tr style="text-align: center;">
										<td style="text-align: center;">
											...
											<a href="${pageContext.request.contextPath }/draft/approve1rt?draftNo=${reinstatement.draftNo}" class="reinstatement"> ${reinstatement.draftNo } </a>
										</td>
