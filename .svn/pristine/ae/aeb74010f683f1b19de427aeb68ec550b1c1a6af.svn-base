   ...
   <div class="panel-heading p-0">
                            ...
                            <div class="tab-overflow">
                                <ul class="nav nav-tabs nav-tabs-inverse" style="text-align: center;">
                                    ...
                                    <li class="active"><a href="${pageContext.servletContext.contextPath}/draft/spendingreject"  style="width: 150px;" >지출결의서</a></li>
...
<table class="table table-striped">
								...
								<c:forEach var="spending" items="${spendingList1 }">
									...
									<tr style="text-align: center;">
										<td style="text-align: center;">
											...
											<a href="${pageContext.request.contextPath }/draft/spview?draftNo=${spending.draftNo}" class="spending"> ${spending.draftNo } </a>
										</td>




										<td style="text-align: center;">${spending.writer }</td>

										<td style="text-align: center;">${spending.spendingTitle }</td>

										<td style="text-align: center;">${spending.writeDate}</td>
										...
										<td>
											 ...
											 <c:if 	test="${spending.approve==1}">미확인</c:if>
											 <c:if 	test="${spending.approve==2}">결재중</c:if>
											 <c:if 	test="${spending.approve==3}">결재중</c:if>
											 <c:if 	test="${spending.approve==4}">결재완료</c:if>
