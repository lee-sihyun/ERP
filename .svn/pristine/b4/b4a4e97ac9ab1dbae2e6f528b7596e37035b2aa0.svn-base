		...
		<div id="content" class="content content-full-width">
			...
			<div class="vertical-box">
				...
				<div class="vertical-box-column">
						...
						<div class="panel-body"
                            ...
                            <div class="tab-overflow">
                                <ul class="nav nav-tabs nav-tabs-inverse" style="text-align: center;">
                                    ...
                                    <li class="active"><a href="${pageContext.servletContext.contextPath}/draft/purchase"  style="width: 150px;" >구매품의서</a></li>
					...
					<!-- 시작 -->
					<div id="titleSection" style="malgun gothic, dotum, arial, tahoma;font-size: 19pt;line-height: normal;margin-top: 0px;margin-left: 350px;font-weight: bold;">구 매 신 청 서</div>
					<div class="ehlfk" >
...
납품요청기한
			...
			<td class="detailColumn dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l">
				<span unselectable="on" contenteditable="false" class="comp_wrap" data-cid="3" data-dsl="{{label:docNo}}"
				 data-wrapper="" style="" data-value="" data-autotype=""><span class="comp_item">
			<input type="text" id="purchaseLimit">
...
구매 요청 부서  
			...
			<td colspan="3" class="detailColumn dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l">
				...
				8px; margin-top: 0px; margin-bottom: 0px;"><span unselectable="on" contenteditable="false" class="comp_wrap"
				 ...
				 <input class="ipt_editor" type="text" id="deptRequest">
...
작 성 자
			...
			<td colspan="1" class="detailColumn dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l">
				...
				<input class="ipt_editor" type="text" id="writer">
...
제 목
			...
			<td colspan="5" class="detailColumn dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l">
				...
				<input class="ipt_editor" type="text" id="purchaseTitle">
...
대금지불방법
		...
		<tr class="copyRow">
			<td class="detailColumn dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l">
				...
				<input class="ipt_editor" type="text" id="purchaseItem">
			...
			<td class="detailColumn dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l">
			 ...
			 <input class="ipt_editor" type="text" id="purchaseSize">
			...
			<td class="detailColumn amount rightCol dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l" style="">
				...
				<input class="ipt_editor ipt_editor_currency" type="text" style="width: 49px;" id="purchaseVolume">
			...
			<td class="detailColumn price rightCol dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l" style="">
				...
				<input class="ipt_editor ipt_editor_currency" type="text" style="width: 89px;" id="purchaseCost">
			...
			<input class="ipt_editor ipt_editor_currency" type="text" style="width: 89px;" id="purchasePrice">
			...
			<td colspan="1" class="detailColumn dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l">
				...
				9pt; line-height: 18px; margin-top: 0px; margin-bottom: 0px;"><span unselectable="on" contenteditable=
  				...
  				data-autotype="">
  				 ...
  				 <input class="ipt_editor" type="text" id="payMethod">
...
합 계
			...
			<td class="detailColumn dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l">
						 <input class="ipt_editor" type="text" id="purchaseAll">
			</td>
...
특이사항
			...
			<td colspan="5" class="detailColumn dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l">
				<p style="font-family: &quot;malgun gothic&quot;, dotum, arial, tahoma; font-size: 9pt; line-height: 18px;
				 ...
				 <textarea class="txta_editor"  id="purchaseMemo" cols="100" rows="15"></textarea>
...
<button type="button"  style="margin-left: 380px;"class="btn btn-primary p-l-40 p-r-40" id="submit" >결재제출</button>
	...
	<script>
		...
		$("#submit").click(function(){
			...
			var purchaseItem=$("#purchaseItem").val();
			var purchaseSize=$("#purchaseSize").val();
			
			
			var purchaseVolume=$("#purchaseVolume").val();
			var purchaseCost=$("#purchaseCost").val();
			var purchasePrice=$("#purchasePrice").val();
			var payMethod=$("#payMethod").val();
			var purchaseAll=$("#purchaseAll").val();
			var purchaseMemo=$("#purchaseMemo").val();
			
			
			var purchaseTitle=$("#purchaseTitle").val();
			var deptRequest=$("#deptRequest").val(); 
			...
			if(purchaseMemo=="") {
				alert("특이사항을 입력해주세요 없는 경우 해당사항없음으로 기입바랍니다.")
				return;
			}
			...
			$.ajax({
				...
				"writer":writer,"purchaseItem":purchaseItem,"purchaseSize":purchaseSize,"purchaseVolume":purchaseVolume,
				"purchaseCost":purchaseCost,"purchasePrice":purchasePrice,"payMethod":payMethod,"purchaseAll":purchaseAll,
				"purchaseMemo":purchaseMemo,"purchaseTitle":purchaseTitle,"deptRequest":deptRequest,"purchaseLimit":purchaseLimit
