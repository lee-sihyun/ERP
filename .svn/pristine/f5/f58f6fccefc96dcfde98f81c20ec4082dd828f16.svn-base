   ...
   <div class="panel-heading p-0">
                            ...
                            <div class="tab-overflow">
                                <ul class="nav nav-tabs nav-tabs-inverse" style="text-align: center;">
                                    ...
                                    <li class="active"><a href="${pageContext.servletContext.contextPath}/draft/purchasereject"  style="width: 150px;" >구매품의서</a></li>
	...
	<table class="table table-striped">
								...
								<c:forEach var="purchase" items="${purchasetRejctList }">
									...
									<tr  style="text-align: center;">
										<td  style="text-align: center;">
											...
											<a href="${pageContext.request.contextPath }/draft/prview?draftNo=${purchase.draftNo}" class="purchase"> ${purchase.draftNo } </a>
										</td>
										...
										<td  style="text-align: center;">
											 ...
											 <c:if 	test="${purchase.approve==4}">결재완료</c:if>
