   ...
   <div class="panel-heading p-0">
                            ...
                            <div class="tab-overflow">
                                <ul class="nav nav-tabs nav-tabs-inverse" style="text-align: center;">
                                    ...
                                    <li class="active"><a href="${pageContext.servletContext.contextPath}/draft/abapprove"  style="width: 150px;" >휴직</a></li>
...
<table class="table table-striped">
								...
								<c:forEach var="absence" items="${abList1 }">
									...
									<tr>
										<td>
											...
											<a href="${pageContext.request.contextPath }/draft/approve1ab?draftNo=${absence.draftNo}" class="absence"> ${absence.draftNo} </a>
										</td>


						
										<td style="text-align: center;">${absence.draftNo }</td>	
