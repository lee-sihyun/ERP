					...
					<div class="col-md-2">
						...
						<div class="hidden-sm hidden-xs">
							...
							<ul class="nav nav-pills nav-stacked nav-inbox">
								<li class="active"><a href="${pageContext.request.contextPath }/draft/display"> <i class="fa fa-inbox fa-fw m-r-5"></i> 결재함
								</a></li>
								...
								<li><a href="${pageContext.request.contextPath }/draft/draftreject"><i class="fa fa-trash-o fa-fw m-r-5"></i> 반려</a></li>
   ...
   <div class="panel-heading p-0">
                            ...
                            <div class="tab-overflow">
                                <ul class="nav nav-tabs nav-tabs-inverse" style="text-align: center;">
                                    ...
                                    <li class=""><a href="${pageContext.servletContext.contextPath}/draft/display" style="width: 150px;" >기안서</a></li>
                                    <li class=""><a href="${pageContext.servletContext.contextPath}/draft/spdisplay"  style="width: 150px;" >지출결의서</a></li>
                                    <li class=""><a href="${pageContext.servletContext.contextPath}/draft/pddisplay"style="width: 150px;" >비품구입</a></li>
                                    <li class=""><a href="${pageContext.servletContext.contextPath}/draft/prdisplay"  style="width: 150px;" >구매품의서</a></li>
                                    <li class=""><a href="${pageContext.servletContext.contextPath}/draft/codisplay"  style="width: 150px;" >회의록</a></li>
                                    <li class=""><a href="${pageContext.servletContext.contextPath}/draft/abdisplay"  style="width: 150px;" >휴직</a></li>
                                    <li class=""><a href="${pageContext.servletContext.contextPath}/draft/resdisplay"  style="width: 150px;" >퇴직</a></li>
                                    <li class="active"><a href="${pageContext.servletContext.contextPath}/draft/rtdisplay"  style="width: 100px;" >복직</a></li>
...
<table class="table table-striped">
								...
								<c:forEach var="reinstatement" items="${rtList }">
