...
<body>
		...
		<div id="content" class="content">
			...
			<div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-body panel-form">
                            <form id="addressUpdate" class="form-horizontal form-bordered" data-parsley-validate="true" name="demo-form" action="javascript:addressUpdate();">
                            	<input type="hidden" value="${outaddress.empNo}" id="empNo" name="empNo">
                            	<input type="hidden" value="${outaddress.addressNo}" id="addressNo" name="addressNo">
								<div class="form-group">
									<label class="control-label col-md-4 col-sm-4" for="fullname">이름 *  :</label>
									<div class="col-md-6 col-sm-6">
										<input class="form-control" type="text" id="addressName" name="addressName" data-parsley-required="true" value="${outaddress.addressName}" />
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-md-4 col-sm-4" for="email">이메일   :</label>
									<div class="col-md-6 col-sm-6">
										<input class="form-control" type="text" id="addressEmail" name="addressEmail" value="${outaddress.addressEmail}" placeholder="Email"  />
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-md-4 col-sm-4" for="email">직급   :</label>
									<div class="col-md-6 col-sm-6">
										<input class="form-control" type="text" id="addressPosition" name="addressPosition" value="${outaddress.addressPosition}"  />
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-md-4 col-sm-4" for="website">회사명   :</label>
									<div class="col-md-6 col-sm-6">
										<input class="form-control" type="text" id="companyName" name="companyName" value="${outaddress.companyName}" />
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-md-4 col-sm-4" for="message">부서   :</label>
									<div class="col-md-6 col-sm-6">
										<input class="form-control" type="text" id="deptName" name="deptName" value="${outaddress.deptName}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6">
										<input class="form-control" type="text" id="addressPhone" name="addressPhone" value="${outaddress.addressPhone}" placeholder="XXX-XXXX-XXX" />
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-md-4 col-sm-4" for="message">회사번호   :</label>
									<div class="col-md-6 col-sm-6">
										<input class="form-control" type="text" id="companyPhone" name="companyPhone" value="${outaddress.companyPhone}"  placeholder="XXX-XXXX-XXX" />
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-md-4 col-sm-4" for="message">회사주소    :</label>
									<div class="col-md-6 col-sm-6">
										<input class="form-control" type="text" id="companyAddress" name="companyAddress"  value="${outaddress.companyAddress}"  />
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-md-4 col-sm-4" for="message">메모 (최대 200)    : </label>
									<div class="col-md-6 col-sm-6">
										<textarea class="form-control" id="memo" name=memo rows="4"  value="${outaddress.memo}" ></textarea>
									</div>
								</div>
								<div class="form-group">
	...
	function addressUpdate() {
		if(confirm("주소록 수정 하시겠습니까?")) {
			$("#addressUpdate").attr("method","post");
			$("#addressUpdate").attr("action","${pageContext.servletContext.contextPath }/address/outaddressUpdate");
