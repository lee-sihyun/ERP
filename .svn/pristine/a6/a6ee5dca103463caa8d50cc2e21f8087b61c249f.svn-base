...
<td style="
    border: 1px solid;
">${resignation.signerOne}</td>
<td style="
    border: 1px solid;
">${resignation.signerTwo}</td>
<td style="
    border: 1px solid;
">${resignation.signerThree}</td>
...
">
 ...
 <c:if 	test="${resignation.approve==4}">결재승인</c:if>
...
<c:if 	test="${resignation.approve==4}">결재승인</c:if>
<c:if 	test="${resignation.approve==3}">결재승인</c:if>
...
">
	 <c:if 	test="${resignation.approve==4}">결재승인</c:if>
 <c:if 	test="${resignation.approve==3}">결재승인</c:if>
 <c:if 	test="${resignation.approve==2}">결재승인</c:if>
<c:if 	test="${resignation.approve==0}">반려</c:if>
...
<p style="font-family: &quot;맑은 고딕&quot;; font-size: 10pt; line-height: 20px; margin-top: 0px; margin-bottom: 0px;"><br></p>
	...
	<script>
		...
		function rejectDraft() {
			 var draftNo="${reinstatement.draftNo}";
			 var signerOneApprove="${reinstatement.signerOneApprove}";
