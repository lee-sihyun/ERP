   ...
   <div class="panel-heading p-0">
                            ...
                            <div class="tab-overflow">
                                <ul class="nav nav-tabs nav-tabs-inverse" style="text-align: center;">
                                    ...
                                    <li class="active"><a href="${pageContext.servletContext.contextPath}/draft/resreject"  style="width: 150px;" >퇴직</a></li>
	...
	<table class="table table-striped">
								...
								<c:forEach var="resignation" items="${resRejctList }">
									...
									<tr style="text-align: center;">
										<td style="text-align: center;">
											...
											<a href="${pageContext.request.contextPath }/draft/resview?draftNo=${resignation.draftNo}" class="resignation"> ${resignation.draftNo } </a>
										</td>




										<td style="text-align: center;">${resignation.writer }</td>

										<td style="text-align: center;">퇴직원</td>

										<td style="text-align: center;">${resignation.writeDate}</td>
										...
										<td style="text-align: center;">
											 ...
											 <c:if 	test="${resignation.approve==1}">미확인</c:if>
											 <c:if 	test="${resignation.approve==2}">결재중</c:if>
											 <c:if 	test="${resignation.approve==3}">결재중</c:if>
											 <c:if 	test="${resignation.approve==4}">결재완료</c:if>
											 <c:if 	test="${resignation.approve==0}">반려</c:if>
