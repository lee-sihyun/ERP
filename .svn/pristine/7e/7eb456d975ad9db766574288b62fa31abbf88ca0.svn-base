   ...
   <div class="panel-heading p-0">
                            ...
                            <div class="tab-overflow">
                                <ul class="nav nav-tabs nav-tabs-inverse" style="text-align: center;">
                                    ...
                                    <li class="active"><a href="${pageContext.servletContext.contextPath}/draft/productreject"style="width: 150px;" >비품구입</a></li>
	...
	<table class="table table-striped">
								...
								<c:forEach var="product" items="${productRejctList }">
									...
									<tr style="text-align: center;">
										<td style="text-align: center;">
											...
											<a href="${pageContext.request.contextPath }/draft/pdview?draftNo=${product.draftNo}" class="product"> ${product.draftNo } </a>
										</td>




										<td style="text-align: center;">${product.writer }</td>




										<td style="text-align: center;">${product.productTitle }</td>

										<td style="text-align: center;">${product.writeDate}</td>
										
										
										<td>
										
											 <c:if 	test="${product.approve==1}">미확인</c:if>
											 <c:if 	test="${product.approve==2}">결재중</c:if>
											 <c:if 	test="${product.approve==3}">결재중</c:if>
											 <c:if 	test="${product.approve==4}">결재완료</c:if>
											 <c:if 	test="${product.approve==0}">반려</c:if>
